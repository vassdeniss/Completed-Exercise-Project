...
namespace Eventures.DesktopApp.AppiumTests
{
    public class AppiumTests : AppiumTestsBase
    {
        ...
        public void Test_Register_Invalid()
        {
            ...
            // Fill in valid data in the fields but leave the email invalid
            ...
            var errorMsgAppered = this.wait
                    ...
                    .Contains("Email field must have a valid email address.");
            ...
            var cancelBtn = driver.FindElementByAccessibilityId("buttonCancel");
            cancelBtn.Click();

            // Assert the "Register a New User" windows disappears
            string pageSource = driver.PageSource;
            Assert.That(!pageSource.Contains(AppiumTests.RegisterAUserWindowName));
        ...
        public void Test_Login_Invalid()
        {
            ...
            // Fill in invalid data in the username field
            var usernameField = driver.FindElementByAccessibilityId("textBoxUsername");
            usernameField.Clear();
            usernameField.SendKeys(string.Empty);
            ...
            // Assert a failure message is displayed and contains the error
            var messageAppears = this.wait
